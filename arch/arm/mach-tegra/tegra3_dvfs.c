...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  4, 0, MHZ,   1,   1, 550, 550,  680,  680,  820,  970, 1040, 1080, 1150, 1200, 1240, 1280, 1320, 1360, 1500, 1600),
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("emc", emc_millivolts, 2, 1, KHZ,   102000, 408000, 408000, 408000, 408000,  667000,  667000,  800000),
	CORE_DVFS("emc", emc_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  625000,  625000),

	CORE_DVFS("sbus", core_millivolts, 0, 1, KHZ,        1, 136000, 164000, 191000, 216000,  216000,  216000,  216000),
	CORE_DVFS("sbus", core_millivolts, 1, 1, KHZ,    51000, 205000, 205000, 227000, 227000,  267000,  267000,  267000),
	CORE_DVFS("sbus", core_millivolts, 2, 1, KHZ,    51000, 205000, 205000, 227000, 227000,  267000,  334000,  334000),
	CORE_DVFS("sbus", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  216000,  216000),

	CORE_DVFS("vi", core_millivolts, 0, 1, KHZ,        1, 216000, 285000, 300000, 300000,  300000,  300000,  300000),
	CORE_DVFS("vi", core_millivolts, 1, 1, KHZ,        1, 216000, 267000, 300000, 371000,  409000,  409000,  409000),
	CORE_DVFS("vi", core_millivolts, 2, 1, KHZ,        1, 219000, 267000, 300000, 371000,  409000,  425000,  425000),
	CORE_DVFS("vi", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  300000,  300000),

#ifdef CONFIG_TEGRA_GPU_OVERCLOCK
	CORE_DVFS("vde", avp_millivolts, 0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("mpe", avp_millivolts, 0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("2d", avp_millivolts,  0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("epp", avp_millivolts, 0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("3d", avp_millivolts,  0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("3d2", avp_millivolts, 0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("se", avp_millivolts,  0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  446000,  484000),

	CORE_DVFS("vde", avp_millivolts, 1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("mpe", avp_millivolts, 1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("2d", avp_millivolts,  1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("epp", avp_millivolts, 1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("3d", avp_millivolts,  1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("3d2", avp_millivolts, 1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("se", avp_millivolts,  1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  446000,  484000),
#else
	CORE_DVFS("vde", avp_millivolts, 0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("mpe", avp_millivolts, 0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("2d", avp_millivolts,  0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("epp", avp_millivolts, 0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("3d", avp_millivolts,  0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("3d2", avp_millivolts, 0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("se", avp_millivolts,  0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000),

	CORE_DVFS("vde", avp_millivolts, 1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("mpe", avp_millivolts, 1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("2d", avp_millivolts,  1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("epp", avp_millivolts, 1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("3d", avp_millivolts,  1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("3d2", avp_millivolts, 1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("se", avp_millivolts,  1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000),
#endif

	CORE_DVFS("vde", avp_millivolts, 2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  520000),
	CORE_DVFS("mpe", avp_millivolts, 2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  520000),
	CORE_DVFS("2d", avp_millivolts, 2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  520000),
	CORE_DVFS("epp", avp_millivolts, 2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  520000),
	CORE_DVFS("3d", avp_millivolts, 2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  520000),
	CORE_DVFS("3d2", avp_millivolts, 2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  520000),
	CORE_DVFS("se", avp_millivolts, 2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  520000),

	CORE_DVFS("vde", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000),
	CORE_DVFS("mpe", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000),
	CORE_DVFS("2d", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000),
	CORE_DVFS("epp", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000),
	CORE_DVFS("3d", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000),
	CORE_DVFS("3d2", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000),
	CORE_DVFS("se", avp_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  650000,  650000),

	CORE_DVFS("host1x", core_millivolts, 0, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  267000,  267000),
	CORE_DVFS("host1x", core_millivolts, 1, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  267000,  267000),
	CORE_DVFS("host1x", core_millivolts, 2, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  267000,  267000),
	CORE_DVFS("host1x", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  300000,  300000),

#ifdef CONFIG_TEGRA_GPU_OVERCLOCK
	CORE_DVFS("cbus", avp_millivolts, 0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  446000,  484000),
	CORE_DVFS("cbus", avp_millivolts, 1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  446000,  484000),
#else
	CORE_DVFS("cbus", avp_millivolts, 0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  416000),
	CORE_DVFS("cbus", avp_millivolts, 1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  416000),
#endif

	CORE_DVFS("cbus", avp_millivolts, 2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  520000),
	CORE_DVFS("cbus", avp_millivolts, 3, 1, KHZ,        1, 484000, 484000, 484000, 484000,  484000,  484000,  484000),

	CORE_DVFS("pll_c", core_millivolts,  -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 1066000, 1066000, 1066000),
	 ...
	 */
	CORE_DVFS("pll_m", core_millivolts, -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 1066000, 1066000, 1066000),
#ifdef CONFIG_TEGRA_PLLM_RESTRICTED
	CORE_DVFS("pll_m", core_millivolts, 2, 1, KHZ,  533000, 800000, 800000, 800000, 800000, 1066000, 1066000, 1066000),
#endif
	/* Core voltages (mV):		    950,   1000,   1050,   1100,   1150,   1200,    1250,     1300 */
	/* Clock limits for I/O peripherals */
	CORE_DVFS("mipi", core_millivolts, 0, 1, KHZ,        1,      1,      1,      1,      1,      1,       1,        1),
	CORE_DVFS("mipi", core_millivolts, 1, 1, KHZ,        1,      1,      1,      1,      1,  60000,   60000,    60000),
	CORE_DVFS("mipi", core_millivolts, 2, 1, KHZ,        1,      1,      1,      1,      1,  60000,   60000,    60000),
	CORE_DVFS("mipi", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,      1,       1,        1),

	CORE_DVFS("fuse_burn", core_millivolts, -1, 1, KHZ,    1,      1,      1,      1,  26000,  26000,   26000,    26000),
	CORE_DVFS("sdmmc1", core_millivolts, -1, 1, KHZ,  104000, 104000, 104000, 104000, 104000, 208000,  208000,   208000),
	CORE_DVFS("sdmmc3", core_millivolts, -1, 1, KHZ,  104000, 104000, 104000, 104000, 104000, 208000,  208000,   208000),
	CORE_DVFS("ndflash", core_millivolts, -1, 1, KHZ,      1, 120000, 120000, 120000, 200000, 200000,  200000,   200000),

	CORE_DVFS("nor", core_millivolts, 0, 1, KHZ,        1, 115000, 130000, 130000, 133000, 133000,  133000,   133000),
	CORE_DVFS("nor", core_millivolts, 1, 1, KHZ,        1, 115000, 130000, 130000, 133000, 133000,  133000,   133000),
	CORE_DVFS("nor", core_millivolts, 2, 1, KHZ,        1, 115000, 130000, 130000, 133000, 133000,  133000,   133000),
	CORE_DVFS("nor", core_millivolts, 3, 1, KHZ,        1,      1,      1,      1,      1,      1,  108000,   108000),

	CORE_DVFS("sbc1", core_millivolts, -1, 1, KHZ,        1,  52000,  60000,  60000,  60000, 100000,  100000,   100000),
	CORE_DVFS("sbc2", core_millivolts,  -1, 1, KHZ,        1,  52000,  60000,  60000,  60000, 100000,  100000,   100000),
	CORE_DVFS("sbc3", core_millivolts,  -1, 1, KHZ,        1,  52000,  60000,  60000,  60000, 100000,  100000,   100000),
	CORE_DVFS("sbc4", core_millivolts, -1, 1, KHZ,        1,  52000,  60000,  60000,  60000, 100000,  100000,   100000),
	CORE_DVFS("sbc5", core_millivolts,  -1, 1, KHZ,        1,  52000,  60000,  60000,  60000, 100000,  100000,   100000),
	CORE_DVFS("sbc6", core_millivolts,  -1, 1, KHZ,        1,  52000,  60000,  60000,  60000, 100000,  100000,   100000),

	CORE_DVFS("usbd", core_millivolts,  -1, 1, KHZ,        1, 480000, 480000, 480000, 480000, 480000,  480000,   480000),
	CORE_DVFS("usb2", core_millivolts,  -1, 1, KHZ,        1, 480000, 480000, 480000, 480000, 480000,  480000,   480000),
	CORE_DVFS("usb3", core_millivolts,  -1, 1, KHZ,        1, 480000, 480000, 480000, 480000, 480000,  480000,   480000),

	CORE_DVFS("sata", core_millivolts,  -1, 1, KHZ,        1, 216000, 216000, 216000, 216000, 216000,  216000,   216000),
	CORE_DVFS("sata_oob", core_millivolts, -1, 1, KHZ,     1, 216000, 216000, 216000, 216000, 216000,  216000,   216000),
	CORE_DVFS("pcie", core_millivolts, -1, 1, KHZ,        1, 250000, 250000, 250000, 250000, 250000,  250000,   250000),
	CORE_DVFS("afi", core_millivolts, -1, 1, KHZ,        1, 250000, 250000, 250000, 250000, 250000,  250000,   250000),
	CORE_DVFS("pll_e", core_millivolts, -1, 1, KHZ,        1, 100000, 100000, 100000, 100000, 100000,  100000,   100000),
	 ...
	 */
	CORE_DVFS("disp1", core_millivolts,  0, 0, KHZ,        1, 120000, 120000, 120000, 120000, 190000,  190000,   190000),
	CORE_DVFS("disp1", core_millivolts,  1, 0, KHZ,        1, 151000, 268000, 268000, 268000, 268000,  268000,   268000),
	CORE_DVFS("disp1", core_millivolts, 2, 0, KHZ,        1, 151000, 268000, 268000, 268000, 268000,  268000,   268000),
	CORE_DVFS("disp1", core_millivolts,  3, 0, KHZ,        1, 120000, 120000, 120000, 120000, 190000,  190000,   190000),

	CORE_DVFS("disp2", core_millivolts, 0, 0, KHZ,        1, 120000, 120000, 120000, 120000, 190000,  190000,   190000),
	CORE_DVFS("disp2", core_millivolts, 1, 0, KHZ,        1, 151000, 268000, 268000, 268000, 268000,  268000,   268000),
	CORE_DVFS("disp2", core_millivolts, 2, 0, KHZ,        1, 151000, 268000, 268000, 268000, 268000,  268000,   268000),
	CORE_DVFS("disp2", core_millivolts, 3, 0, KHZ,        1, 120000, 120000, 120000, 120000, 190000,  190000,   190000),

	CORE_DVFS("pwm", core_millivolts, -1, 1, KHZ,        1, 408000, 408000, 408000, 408000, 408000,  408000,   408000),
	CORE_DVFS("spdif_out", core_millivolts, -1, 1, KHZ,    1,  26000,  26000,  26000,  26000,  26000,   26000,    26000),
};
